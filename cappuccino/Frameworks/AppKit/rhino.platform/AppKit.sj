...
p;17;_CPCibConnector.jI;21;Foundation/CPObject.jI;29;Foundation/CPKeyValueCoding.jc;3305;
...
p;18;_CPCibCustomView.ji;8;CPView.jc;2760;
...
p;9;CPColor.jI;21;Foundation/CPObject.ji;9;CGColor.ji;17;CPCompatibility.ji;9;CPImage.jc;13261;
...
var _14=_13.isa;
class_addMethods(_14,[new objj_method(sel_getUid("randomColor"),function(_a0,_a1){
with(_a0){
return objj_msgSend(CPColor,"colorWithRed:green:blue:alpha:",RAND(),RAND(),RAND(),1);
}
})]);
var _a2="CPColorComponentsKey",_a3="CPColorPatternImageKey";
var _13=objj_getClass("CPColor");
if(!_13){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPColor\""));
}
var _14=_13.isa;
class_addMethods(_13,[new objj_method(sel_getUid("initWithCoder:"),function(_a4,_a5,_a6){
with(_a4){
if(objj_msgSend(_a6,"containsValueForKey:",_a3)){
return objj_msgSend(_a4,"_initWithPatternImage:",objj_msgSend(_a6,"decodeObjectForKey:",_a3));
}
return objj_msgSend(_a4,"_initWithRGBA:",objj_msgSend(_a6,"decodeObjectForKey:",_a2));
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_a7,_a8,_a9){
with(_a7){
if(_patternImage){
objj_msgSend(_a9,"encodeObject:forKey:",_patternImage,_a3);
}else{
objj_msgSend(_a9,"encodeObject:forKey:",_components,_a2);
}
}
})]);
var _aa="0123456789ABCDEF";
...
if(_aa.indexOf(hex.charAt(i))==-1){
return null;
}
}
var red=(_aa.indexOf(hex.charAt(0))*16+_aa.indexOf(hex.charAt(1)))/255;
var _ae=(_aa.indexOf(hex.charAt(2))*16+_aa.indexOf(hex.charAt(3)))/255;
var _af=(_aa.indexOf(hex.charAt(4))*16+_aa.indexOf(hex.charAt(5)))/255;
return [red,_ae,_af,1];
};
integerToBytes=function(_b0,_b1){
if(!_b1){
_b1=(_b0==0)?1:Math.round((Math.log(_b0)/Math.log(2))/8+0.5);
}
var _b2=new Array(_b1);
for(var i=_b1-1;i>=0;i--){
_b2[i]=_b0&255;
_b0=_b0>>8;
}
return _b2;
...
return _aa.charAt((n-n%16)/16)+_aa.charAt(n%16);
};
...
p;19;CPDOMWindowBridge.jI;21;Foundation/CPObject.jI;22;Foundation/CPRunLoop.ji;9;CPEvent.ji;17;CPCompatibility.ji;18;CPDOMWindowLayer.jc;19128;
...
p;8;CPMenu.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPString.ji;15;CPApplication.ji;12;CPClipView.ji;12;CPMenuItem.ji;9;CPPanel.jc;47823;
...
p;14;CPPasteboard.jI;21;Foundation/CPObject.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;40;Foundation/CPPropertyListSerialization.jc;4532;
...
p;8;CPView.jI;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;20;CPDOMDisplayServer.ji;12;CPGeometry.ji;19;CPGraphicsContext.ji;13;CPResponder.ji;9;CPTheme.jc;40662;
CPViewNotSizable=0;
CPViewMinXMargin=1;
