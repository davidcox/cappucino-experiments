...
p;9;CPArray.ji;10;CPObject.ji;9;CPRange.ji;14;CPEnumerator.ji;18;CPSortDescriptor.ji;13;CPException.jc;17623;
...
with(_9f){
var i=0,_a2=objj_msgSend(_9f,"count"),_a3="(";
for(;i<_a2;++i){
if(_9f[i].isa){
_a3+=objj_msgSend(_9f[i],"description");
}else{
_a3+=_9f[i];
}
if(i!=_a2-1){
...
}),new objj_method(sel_getUid("pathsMatchingExtensions:"),function(_a4,_a5,_a6){
with(_a4){
var _a7=0,_a8=objj_msgSend(_a4,"count"),_a9=[];
for(;_a7<_a8;++_a7){
if(_a4[_a7].isa&&objj_msgSend(_a4[_a7],"isKindOfClass:",objj_msgSend(CPString,"class"))&&objj_msgSend(_a6,"containsObject:",objj_msgSend(_a4[_a7],"pathExtension"))){
_a9.push(_a4[_a7]);
}
}
return _a9;
}
}),new objj_method(sel_getUid("setValue:forKey:"),function(_aa,_ab,_ac,_ad){
with(_aa){
var i=0,_af=objj_msgSend(_aa,"count");
for(;i<_af;++i){
objj_msgSend(_aa[i],"setValue:forKey:",_ac,_ad);
}
}
}),new objj_method(sel_getUid("valueForKey:"),function(_b0,_b1,_b2){
with(_b0){
var i=0,_b4=objj_msgSend(_b0,"count"),_b5=[];
for(;i<_b4;++i){
_b5.push(objj_msgSend(_b0[i],"valueForKey:",_b2));
}
return _b5;
}
...
with(_c2){
var i=2,_c6=objj_msgSend(objj_msgSend(_c2,"alloc"),"init"),_c7;
for(;i<arguments.length&&(_c7=arguments[i])!=nil;++i){
_c6.push(_c7);
}
return _c6;
}
}),new objj_method(sel_getUid("arrayWithObjects:count:"),function(_c8,_c9,_ca,_cb){
with(_c8){
return objj_msgSend(objj_msgSend(_c8,"alloc"),"initWithObjects:count:",_ca,_cb);
}
})]);
var _1=objj_getClass("CPArray");
if(!_1){
...
var _2=_1.isa;
class_addMethods(_1,[new objj_method(sel_getUid("initWithCapacity:"),function(_cc,_cd,_ce){
with(_cc){
return _cc;
}
}),new objj_method(sel_getUid("addObject:"),function(_cf,_d0,_d1){
with(_cf){
push(_d1);
}
}),new objj_method(sel_getUid("addObjectsFromArray:"),function(_d2,_d3,_d4){
with(_d2){
splice.apply(_d2,[length,0].concat(_d4));
}
}),new objj_method(sel_getUid("insertObject:atIndex:"),function(_d5,_d6,_d7,_d8){
with(_d5){
splice(_d8,0,_d7);
}
}),new objj_method(sel_getUid("insertObjects:atIndexes:"),function(_d9,_da,_db,_dc){
with(_d9){
var _dd=objj_msgSend(_dc,"count"),_de=objj_msgSend(_db,"count");
if(_dd!==_de){
objj_msgSend(CPException,"raise:reason:",CPRangeException,"the counts of the passed-in array ("+_de+") and index set ("+_dd+") must be identical.");
}
var _df=objj_msgSend(_dc,"lastIndex");
if(_df>=objj_msgSend(_d9,"count")+_dd){
objj_msgSend(CPException,"raise:reason:",CPRangeException,"the last index ("+_df+") must be less than the sum of the original count ("+objj_msgSend(_d9,"count")+") and the insertion count ("+_dd+").");
}
var _e0=0,_e1=objj_msgSend(_dc,"firstIndex");
for(;_e0<_de;++_e0,_e1=objj_msgSend(_dc,"indexGreaterThanIndex:",_e1)){
objj_msgSend(_d9,"insertObject:atIndex:",_db[_e0],_e1);
}
}
}),new objj_method(sel_getUid("replaceObjectAtIndex:withObject:"),function(_e2,_e3,_e4,_e5){
with(_e2){
_e2[_e4]=_e5;
}
}),new objj_method(sel_getUid("replaceObjectsAtIndexes:withObjects:"),function(_e6,_e7,_e8,_e9){
with(_e6){
var i=0,_eb=objj_msgSend(_e8,"firstIndex");
while(_eb!=CPNotFound){
objj_msgSend(_e6,"replaceObjectAtIndex:withObject:",_eb,_e9[i++]);
_eb=objj_msgSend(_e8,"indexGreaterThanIndex:",_eb);
}
}
}),new objj_method(sel_getUid("replaceObjectsInRange:withObjectsFromArray:range:"),function(_ec,_ed,_ee,_ef,_f0){
with(_ec){
if(!_f0.location&&_f0.length==objj_msgSend(_ef,"count")){
objj_msgSend(_ec,"replaceObjectsInRange:withObjectsFromArray:",_ee,_ef);
}else{
splice.apply(_ec,[_ee.location,_ee.length].concat(objj_msgSend(_ef,"subarrayWithRange:",_f0)));
}
}
}),new objj_method(sel_getUid("replaceObjectsInRange:withObjectsFromArray:"),function(_f1,_f2,_f3,_f4){
with(_f1){
splice.apply(_f1,[_f3.location,_f3.length].concat(_f4));
}
}),new objj_method(sel_getUid("setArray:"),function(_f5,_f6,_f7){
with(_f5){
if(_f5==_f7){
return;
}
splice.apply(_f5,[0,length].concat(_f7));
}
}),new objj_method(sel_getUid("removeAllObjects"),function(_f8,_f9){
with(_f8){
splice(0,length);
}
}),new objj_method(sel_getUid("removeLastObject"),function(_fa,_fb){
with(_fa){
pop();
}
}),new objj_method(sel_getUid("removeObject:"),function(_fc,_fd,_fe){
with(_fc){
objj_msgSend(_fc,"removeObject:inRange:",_fe,CPMakeRange(0,length));
}
}),new objj_method(sel_getUid("removeObject:inRange:"),function(_ff,_cmd,_101,_102){
with(_ff){
var _103;
while((_103=objj_msgSend(_ff,"indexOfObject:inRange:",_101,_102))!=CPNotFound){
objj_msgSend(_ff,"removeObjectAtIndex:",_103);
_102=CPIntersectionRange(CPMakeRange(_103,length-_103),_102);
}
}
}),new objj_method(sel_getUid("removeObjectAtIndex:"),function(self,_cmd,_106){
with(self){
splice(_106,1);
}
}),new objj_method(sel_getUid("removeObjectsAtIndexes:"),function(self,_cmd,_109){
with(self){
var _10a=objj_msgSend(_109,"lastIndex");
while(_10a!=CPNotFound){
objj_msgSend(self,"removeObjectAtIndex:",_10a);
_10a=objj_msgSend(_109,"indexLessThanIndex:",_10a);
}
}
}),new objj_method(sel_getUid("removeObjectIdenticalTo:"),function(self,_cmd,_10d){
with(self){
objj_msgSend(self,"removeObjectIdenticalTo:inRange:",_10d,CPMakeRange(0,length));
}
}),new objj_method(sel_getUid("removeObjectIdenticalTo:inRange:"),function(self,_cmd,_110,_111){
with(self){
var _112;
while((_112=objj_msgSend(self,"indexOfObjectIdenticalTo:inRange:",_110,_111))!=CPNotFound){
objj_msgSend(self,"removeObjectAtIndex:",_112);
_111=CPIntersectionRange(CPMakeRange(_112,length-_112),_111);
}
}
}),new objj_method(sel_getUid("removeObjectsInArray:"),function(self,_cmd,_115){
with(self){
var _116=0,_117=objj_msgSend(_115,"count");
for(;_116<_117;++_116){
objj_msgSend(self,"removeObject:",_115[_116]);
}
}
}),new objj_method(sel_getUid("removeObjectsInRange:"),function(self,_cmd,_11a){
with(self){
splice(_11a.location,_11a.length);
}
}),new objj_method(sel_getUid("exchangeObjectAtIndex:withObjectAtIndex:"),function(self,_cmd,_11d,_11e){
with(self){
var _11f=self[_11d];
self[_11d]=self[_11e];
self[_11e]=_11f;
}
}),new objj_method(sel_getUid("sortUsingDescriptors:"),function(self,_cmd,_122){
with(self){
sort(function(lhs,rhs){
var i=0,_126=objj_msgSend(_122,"count"),_127=CPOrderedSame;
while(i<_126){
if((_127=objj_msgSend(_122[i++],"compareObject:withObject:",lhs,rhs))!=CPOrderedSame){
return _127;
}
}
return _127;
...
}),new objj_method(sel_getUid("sortUsingFunction:context:"),function(self,_cmd,_12a,_12b){
with(self){
sort(function(lhs,rhs){
return _12a(lhs,rhs,_12b);
});
}
}),new objj_method(sel_getUid("sortUsingSelector:"),function(self,_cmd,_130){
with(self){
sort(function(lhs,rhs){
return objj_msgSend(lhs,_130,rhs);
});
}
})]);
class_addMethods(_2,[new objj_method(sel_getUid("arrayWithCapacity:"),function(self,_cmd,_135){
with(self){
return objj_msgSend(objj_msgSend(self,"alloc"),"initWithCapacity:",_135);
}
})]);
var _1=objj_getClass("CPArray");
if(!_1){
...
var _2=_1.isa;
class_addMethods(_1,[new objj_method(sel_getUid("initWithCoder:"),function(self,_cmd,_138){
with(self){
return objj_msgSend(_138,"decodeObjectForKey:","CP.objects");
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(self,_cmd,_13b){
with(self){
objj_msgSend(_13b,"_encodeArrayOfObjects:forKey:",self,"CP.objects");
}
})]);
...
p;19;CPJSONPConnection.jI;21;Foundation/CPObject.jc;3290;
...
with(_e){
try{
CPJSONPConnectionCallbacks["callback"+objj_msgSend(_e,"hash")]=function(_10){
...
_12+=(_12.indexOf("?")<0)?"?":"&";
_12+=_callbackParameter+"=CPJSONPConnectionCallbacks.callback"+objj_msgSend(_e,"hash");
}else{
if(_12.indexOf(CPJSONPCallbackReplacementString)>=0){
_12=objj_msgSend(_12,"stringByReplacingOccurrencesOfString:withString:",CPJSONPCallbackReplacementString,"CPJSONPConnectionCallbacks.callback"+objj_msgSend(_e,"hash"));
}else{
return;
}
}
...
}),new objj_method(sel_getUid("class"),function(_64,_65){
with(_64){
return _64;
}
}),new objj_method(sel_getUid("superclass"),function(_66,_67){
with(_66){
return super_class;
}
}),new objj_method(sel_getUid("isSubclassOfClass:"),function(_68,_69,_6a){
with(_68){
var _6b=_68;
for(;_6b;_6b=_6b.super_class){
if(_6b===_6a){
return YES;
}
}
...
}),new objj_method(sel_getUid("isKindOfClass:"),function(_6c,_6d,_6e){
with(_6c){
return objj_msgSend(_6c,"isSubclassOfClass:",_6e);
}
}),new objj_method(sel_getUid("isMemberOfClass:"),function(_6f,_70,_71){
with(_6f){
return _6f===_71;
}
}),new objj_method(sel_getUid("instancesRespondToSelector:"),function(_72,_73,_74){
with(_72){
return !!class_getInstanceMethod(_72,_74);
}
}),new objj_method(sel_getUid("instanceMethodForSelector:"),function(_75,_76,_77){
with(_75){
return class_getMethodImplementation(_75,_77);
}
}),new objj_method(sel_getUid("setVersion:"),function(_78,_79,_7a){
with(_78){
version=_7a;
return _78;
}
}),new objj_method(sel_getUid("version"),function(_7b,_7c){
with(_7b){
return version;
}
})]);
...
p;10;CPString.ji;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.ji;9;CPValue.jc;9368;
